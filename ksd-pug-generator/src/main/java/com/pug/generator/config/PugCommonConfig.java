...
public class PugCommonConfig {
    ...
    public static class Builder implements IPugConfigBuilder<PugCommonConfig> {
        private PugCommonConfig pugCommonConfig;

        public Builder() {
            this.pugCommonConfig = new PugCommonConfig();
        }

        @Override
        public PugCommonConfig build() {
            return pugCommonConfig;
        }
    }

    public PugCommonConfig create(PugPackageConfig pugPackageConfig) {
    ...
    public PugCommonConfig templateResource(String target, String writerTargetPath) {
        try {
//            if(this.isoverride){
//                return this;
//            }
    ...
    public PugCommonConfig template(String target, String writerTargetPath) {
        try {
//            if(this.isoverride){
//                return this;
//            }
