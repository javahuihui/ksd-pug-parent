 ...
 */
@Data
public class PugDataSourceConfig {

    private PugDataSourceConfig() {
    }
    ...
    public static class Builder {
         ...
         * @return 数据库配置
         */
        public PugDataSourceConfig build() {
            PugDataSourceConfig pugDataSourceConfig = new PugDataSourceConfig();
