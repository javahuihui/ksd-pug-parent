...
import com.pug.generator.freemarker.tool.JDBCTypesUtils;
import com.pug.generator.freemarker.tool.Tool;
 ...
 */
@Data
public class PugDataTableSourceConfig {
    // 操作的表
    ...
    private PugDataTableSourceConfig() {
    }
    ...
    public static class Builder {
         ...
         * @return 数据库配置
         */
        public PugDataTableSourceConfig buildTableInfo(PugDataSourceConfig pugDataSourceConfig) {
            this.pugDataSourceConfig = pugDataSourceConfig;
            PugDataTableSourceConfig dataTableSourceConfig = new PugDataTableSourceConfig();
            dataTableSourceConfig.tablename = tablename;
            dataTableSourceConfig.tableInfos = loadTable();
            return dataTableSourceConfig;
        }

        public PugDataTableSourceConfig buildTables(PugDataSourceConfig pugDataSourceConfig) {
            this.pugDataSourceConfig = pugDataSourceConfig;
            PugDataTableSourceConfig dataTableSourceConfig = new PugDataTableSourceConfig();
        ...
        public List<String> loadAllTable() {
            ...
            ResultSet rs1 = null;
            try {
                conn = this.pugDataSourceConfig.getConn();
