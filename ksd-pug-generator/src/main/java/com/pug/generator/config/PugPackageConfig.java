...
import com.pug.commons.utils.StringUtils;
...
public class PugPackageConfig {
    ...
    public static class Builder implements IPugConfigBuilder<PugPackageConfig> {

        private final PugPackageConfig pugPackageConfig;

        public Builder() {
            this.pugPackageConfig = new PugPackageConfig();
        }
