...
(function () {
    var P = window;
    var i = ["break,sudo,root,go,continue,do,else,for,if,return,rabbitmqctl,docker,ps,more,ef,netstat,vim,vi,while,systemctl,wget,cd,rpm,yum,install,cd,remove,rename,erl"];
    var u = [i, "start","stop","restart","enable","disable","status","auto,case,char,const,default," + "double,enum,extern,float,goto,inline,int,long,register,short,signed," + "sizeof,static,struct,switch,typedef,union,unsigned,void,volatile"];
    ...
    var g = [i, "version,alias,and,begin,case,class," + "def,defined,elsif,end,ensure,false,in,module,next,nil,not,or,redo," + "rescue,retry,self,super,then,true,undef,unless,until,when,yield," + "BEGIN,END"];
